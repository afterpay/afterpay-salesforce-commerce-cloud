...
var utilitiesMock = {
    checkoutUtilities: {
        getPaymentTransaction: function () { return paymentTransaction; }
    }
};
...
describe('afterpayUpdatePreapprovalStatus', function () {
         ...
         var afterpayUpdatePreapprovalStatus = proxyquire('../../../../../cartridges/int_afterpay_sfra/cartridge/scripts/checkout/afterpayUpdatePreapprovalStatus', {
