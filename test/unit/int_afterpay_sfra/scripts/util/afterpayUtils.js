...
describe('afterpayUtils', function () {
	...
	var afterpayUtils = proxyquire('../../../../../cartridges/int_afterpay_sfra/cartridge/scripts/util/afterpayUtils.js', {
               	 'dw/web/Resource': {
                     	msg: function () {
                        	return 'someString';
                    	}
                ...
                '*/cartridge/scripts/util/afterpayDisplayProductMessage': {
                    getThresholdRange: function () { return {}; }
                },
    ...
    describe('#maskDetail', function () {
     ...
     describe('#showAfterpayPayment', function () {

		it('show payment method configuration', function() {
            var result = afterpayUtils.showAfterpayPayment();
