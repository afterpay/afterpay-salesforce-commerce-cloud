...
(function () {
    ...
    Class.extend = function (prop) {
        ...
        for (var name in prop) { // eslint-disable-line
            // Check if we're overwriting an existing function
            prototype[name] =
                typeof prop[name] === 'function' && typeof _super[name] === 'function' && fnTest.test(prop[name]) ? callback(name, prop[name]) : prop[name]; // eslint-disable-line
        }

        // The dummy class constructor
        function Class() { // eslint-disable-line
        ...
        Class.extend = arguments.callee; // eslint-disable-line
