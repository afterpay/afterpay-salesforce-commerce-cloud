...
var PaymentService = Class.extend({
    ...
    generateRequest: function (token, paymentID) {
        ...
        this._requestUrl = StringUtils.format(this.afterpayApiContext.getFlowApiUrls().get('getPayment'), param); // eslint-disable-line
    },

    getResponse: function () {
        var response = this.afterpayHttpService.call(this._requestUrl, 'GET_PAYMENT', { requestMethod: 'GET' }); // eslint-disable-line
        return response;
    }
});
