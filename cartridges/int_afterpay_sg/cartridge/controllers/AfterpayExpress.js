...
function FinalizeOrder() {
    ...
    // needed so checkout thinks we're past billing stage
    session.forms.billing.fulfilled.value = true;
    require('*/cartridge/scripts/checkout/afterpayUpdatePreapprovalStatus').getPreApprovalResult(cart.object, { status: 'SUCCESS', orderToken: apOrderToken, apExpressCheckout: true, apExpressCheckoutChecksum: widgetChecksum });
