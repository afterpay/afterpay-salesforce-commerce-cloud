...
function getErrorResponses(responseCode, tokenErrorMessage){
    ...
    switch(statusCode) {
	    ...
	    case 524:
	        ...
	        break;  
	    case "TOKEN_ERROR":
	    	errorMessage = Resource.msg('afterpay.invalid.email.error','afterpay',null);
	        break;  
	    default:
 ...
 */
module.exports = {
	GetErrorResponses: function(responseCode, tokenErrorMessage){
		return getErrorResponses(responseCode, tokenErrorMessage);
	}
}
